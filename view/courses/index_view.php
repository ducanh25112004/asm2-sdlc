                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group my-3">
                                ...
                                <a class="btn btn-primary btn-sm" href="index.php?c=courses"> Back to list</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($courses as $key => $item) : ?> 
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning btn-sm btn-outline-secondary" href="index.php?c=courses&m=delete&id=<?= $item['id']; ?>"> Delete</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
