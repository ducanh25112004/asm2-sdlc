        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a class="btn btn-success" href="index.php?c=courses&m=add"> Create new Courses</a>
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group my-3">
                                <input id="keywordCourses" type="text" name="search" value="<?= htmlentities($keyword); ?>" />
                                <button id="btnSearchCourses" type="button" class="btn btn-success btn-sm mb-0"> Search</button>
                        ...
                        <tbody>
                            <?php foreach ($courses as $key => $item) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="index.php?c=courses&m=edit&id=<?= $item['id']; ?>"> Edit</a>
                                    </td>
                                    <td>
